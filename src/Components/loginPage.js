...
class Login extends Component {
    render() {
        if(GlobalStore.islogin){
            this.props.history.push("/homepage/" + GlobalStore.accounts.id);
        }
        return (
                                            ...
                                            <div className="row">
                                                <div className="col-xl-12 col-lg-12 col-md-12">
                                                    <div className="form-group label-floating is-empty">
                                                        ...
                                                        <input className="form-control" placeholder type="email" id="username"/>
                                                        <span className="material-input" /></div>
                                                    <div className="form-group label-floating is-empty">
                                                        <label className="control-label">Your Password</label>
                                                        <input className="form-control" placeholder type="password" id="password"/>
                                                        <span className="material-input" /></div>
                                                
                                                    <a className="btn btn-lg btn-primary full-width" onClick={login => {GlobalStore.login($('#username').val(), $('#password').val()); if(GlobalStore.islogin){this.props.history.push("/homepage/" + GlobalStore.accounts.id)}}}>Login</a>
                                                    <div className="or" />
